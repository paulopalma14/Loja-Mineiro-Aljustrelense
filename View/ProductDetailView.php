...
class ProductDetailView
{
    ...
    public function showAddButton($id){

        echo '<div class="aa-prod-view-bottom"><a id="btnAdd" class="aa-add-to-cart-btn" href="addProduct.php?id='.$id.'">Adicionar ao Carrinho</a></div></div></div>\';';
    }
